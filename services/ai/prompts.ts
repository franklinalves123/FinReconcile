...
4. Campos obrigatórios por transação:
   ...
   - type: "expense" para compras, serviços, assinaturas, anuidade e tarifas; "income" para estornos, créditos e devoluções de compra (regra 2a). Se omitido, vale "expense".
